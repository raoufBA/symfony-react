...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder047b8 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer8e40c = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiesdf8e7 = [
        
    ];

    public function getConnection()
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'getConnection', array(), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'getMetadataFactory', array(), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'getExpressionBuilder', array(), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'beginTransaction', array(), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'getCache', array(), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->getCache();
    }

    public function transactional($func)
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'transactional', array('func' => $func), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->transactional($func);
    }

    public function commit()
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'commit', array(), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->commit();
    }

    public function rollback()
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'rollback', array(), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'getClassMetadata', array('className' => $className), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'createQuery', array('dql' => $dql), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'createNamedQuery', array('name' => $name), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'createQueryBuilder', array(), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'flush', array('entity' => $entity), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'clear', array('entityName' => $entityName), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->clear($entityName);
    }

    public function close()
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'close', array(), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->close();
    }

    public function persist($entity)
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'persist', array('entity' => $entity), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'remove', array('entity' => $entity), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'refresh', array('entity' => $entity), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'detach', array('entity' => $entity), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'merge', array('entity' => $entity), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'getRepository', array('entityName' => $entityName), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'contains', array('entity' => $entity), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'getEventManager', array(), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'getConfiguration', array(), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'isOpen', array(), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'getUnitOfWork', array(), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'getProxyFactory', array(), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'initializeObject', array('obj' => $obj), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'getFilters', array(), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'isFiltersStateClean', array(), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'hasFilters', array(), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return $this->valueHolder047b8->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer8e40c = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder047b8) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder047b8 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder047b8->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, '__get', ['name' => $name], $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        if (isset(self::$publicPropertiesdf8e7[$name])) {
            return $this->valueHolder047b8->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder047b8;
    ...
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;
    ...
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, '__isset', array('name' => $name), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;
    ...
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, '__unset', array('name' => $name), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;
    ...
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, '__clone', array(), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        $this->valueHolder047b8 = clone $this->valueHolder047b8;
    }

    public function __sleep()
    {
        $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, '__sleep', array(), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;

        return array('valueHolder047b8');
    }
    ...
    {
        $this->initializer8e40c = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer8e40c;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer8e40c && ($this->initializer8e40c->__invoke($valueHolder047b8, $this, 'initializeProxy', array(), $this->initializer8e40c) || 1) && $this->valueHolder047b8 = $valueHolder047b8;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder047b8;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder047b8;
    }
}
