...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('gonFD3i10S', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('dnotIVbouS', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('E7zm3up8XX', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('XkAKAs5w+j', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vE1QsGW2KU', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('dmbr-QLkSf', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('aweWBhZkPe', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder8aa65 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5380f = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties9d496 = [
        
    ];

    public function getConnection()
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'getConnection', array(), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'getMetadataFactory', array(), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'getExpressionBuilder', array(), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'beginTransaction', array(), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'getCache', array(), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->getCache();
    }

    public function transactional($func)
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'transactional', array('func' => $func), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->transactional($func);
    }

    public function commit()
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'commit', array(), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->commit();
    }

    public function rollback()
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'rollback', array(), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'getClassMetadata', array('className' => $className), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'createQuery', array('dql' => $dql), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'createNamedQuery', array('name' => $name), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'createQueryBuilder', array(), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'flush', array('entity' => $entity), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'clear', array('entityName' => $entityName), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->clear($entityName);
    }

    public function close()
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'close', array(), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->close();
    }

    public function persist($entity)
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'persist', array('entity' => $entity), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'remove', array('entity' => $entity), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'refresh', array('entity' => $entity), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'detach', array('entity' => $entity), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'merge', array('entity' => $entity), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'getRepository', array('entityName' => $entityName), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'contains', array('entity' => $entity), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'getEventManager', array(), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'getConfiguration', array(), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'isOpen', array(), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'getUnitOfWork', array(), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'getProxyFactory', array(), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'initializeObject', array('obj' => $obj), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'getFilters', array(), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'isFiltersStateClean', array(), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'hasFilters', array(), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return $this->valueHolder8aa65->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer5380f = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder8aa65) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder8aa65 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder8aa65->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, '__get', ['name' => $name], $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        if (isset(self::$publicProperties9d496[$name])) {
            return $this->valueHolder8aa65->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder8aa65;
    ...
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;
    ...
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, '__isset', array('name' => $name), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;
    ...
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, '__unset', array('name' => $name), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;
    ...
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, '__clone', array(), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        $this->valueHolder8aa65 = clone $this->valueHolder8aa65;
    }

    public function __sleep()
    {
        $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, '__sleep', array(), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;

        return array('valueHolder8aa65');
    }
    ...
    {
        $this->initializer5380f = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer5380f;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer5380f && ($this->initializer5380f->__invoke($valueHolder8aa65, $this, 'initializeProxy', array(), $this->initializer5380f) || 1) && $this->valueHolder8aa65 = $valueHolder8aa65;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder8aa65;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder8aa65;
    }
}
